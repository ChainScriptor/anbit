      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative flex h-[min(870px,calc(100dvh-1.5rem))] min-h-[min(520px,90dvh)] w-full max-w-[1180px] flex-col overflow-hidden rounded-xl border border-zinc-800/50 bg-black shadow-[0_0_80px_rgba(0,0,0,0.5)] md:flex-row md:rounded-2xl"
