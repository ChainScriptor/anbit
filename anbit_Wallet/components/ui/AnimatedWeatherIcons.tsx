...
const WEATHER_ICONS: Record<WeatherType, React.ComponentType<WeatherIconProps>> = {
  sun: SunIcon,
  moon: MoonIcon,
  cloud: CloudIcon,
...
export function getWeatherIcon(type: WeatherType): React.ComponentType<WeatherIconProps> {
  return WEATHER_ICONS[type] ?? SunIcon;
}
