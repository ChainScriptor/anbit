...
export const AwardBadge = ({ type, place, link }: AwardBadgeProps) => {
  ...
  const getMatrix = (clientX: number, clientY: number) => {
    ...
    const scale = [
      maxScale -
        ((maxScale - minScale) * Math.abs(xCenter - clientX)) / (xCenter - left),
      maxScale -
  ...
  return (
    <a
      ...
      className="block h-auto w-[180px] cursor-pointer sm:w-[220px]"
            ...
            {[...Array(10).keys()].map((idx) => (
              <g
                ...
                style={{
                  ...
                  animation: disableOverlayAnimation ? 'none' : `overlayAnimation${idx + 1} 5s infinite`,
              ...
              >
                <polygon
                  ...
                  fill={
                    ['hsl(358, 100%, 62%)', 'hsl(30, 100%, 50%)', 'hsl(60, 100%, 50%)', 'hsl(96, 100%, 50%)', 'hsl(233, 85%, 47%)', 'hsl(271, 85%, 47%)', 'hsl(300, 20%, 35%)', 'transparent', 'transparent', 'white'][idx]
                  }
                  filter="url(#blur1)"
                  opacity="0.5"
                />
